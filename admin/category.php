        ...
        <div class="row">
            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="core/insert.php" method="post">
                ...
                <div class="col-md-12">
                    <label>Chose your parent category if any</label>
                    ...
                    while($row =  mysqli_fetch_assoc($category_res)){
                        ...
                        ?>
                         <tr>
                            ...
                            <td><img src="assets/img/products/category/<?php echo $cat_image;?>" width="50"/>
                        </td>
                            <td><?php echo $cat_name;?></td>
                            <td><?php if ($cat_status ==0)echo '<span class="badge bg-danger">Inactive</span>';else echo '<span class="badge bg-success">Active</span>';  ?>
                        </td>
                        <td>
